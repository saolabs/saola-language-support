...
class OneFormatter {
    async provideDocumentFormattingEdits(document, options, _token) {
        ...
        try {
            ...
            console.error('ONE Formatter error:', e);
            return [];
        }
    }
    /**
     * Format entire .one document using line-by-line indent tracking
     */
    formatDocument(content, indent) {
        ...
        const fileOpenDirectives = new Set();
        const fileCloseDirectives = new Set();
     ...
     */
    countParensOutsideStrings(text) {
        let depth = 0;
        let inString = null;
...
exports.OneFormatter = OneFormatter;
//# sourceMappingURL=oneFormatter.js.map